...
\author{
    ...
    \thanks{The authors are with the Department of XXX, University YYY, City, Country (e-mail: author@university.edu).}
}

\markboth{Journal of \LaTeX\ Class Files,~Vol.~XX, No.~XX, Month~Year}%
...
% 若使用双栏排版且第二栏需避开页脚ID，请在第二栏开头加 \IEEEpubidadjcol

\maketitle

\begin{abstract}
This paper presents a resource-efficient architecture for a 1024-point FFT based on time-multiplexed constant multipliers. The proposed design reduces hardware cost while maintaining high throughput and numerical accuracy\cite{dummy2025}.
\end{abstract}
...
% Comparison with prior works, resource usage, latency, throughput, error analysis
